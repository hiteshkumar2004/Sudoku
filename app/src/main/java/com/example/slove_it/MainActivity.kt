        ...
        if (d!=e&&d!=f&&f!=e){
            if (i!=j && i!=k && k!=j && d!=i && d!=j && d!=k && e!=i && e!=j && e!=k&&f!=i &&f!=j &&f!=k){
                if (l != m && l != n && n != m&& d!= l && d!= m && d!=n&& e!= l && e!= m && e!=n&& f!= l && f!= m && f!=n&& i!= l
                    ...
                    //block 1
                          b1.text="$d" ;b1.setBackgroundResource(R.drawable.org);b1.setOnClickListener { b1.text="$d" };b1.setTextColor(resources.getColor(R.color.black))
                          b2.text="$f" ;b2.setBackgroundResource(R.drawable.org);b2.setOnClickListener { b2.text="$f" };b2.setTextColor(resources.getColor(R.color.black))
                          b3.text="$k" ;b3.setBackgroundResource(R.drawable.org);b3.setOnClickListener { b3.text="$k" };b3.setTextColor(resources.getColor(R.color.black))
                          b4.text="$e" ;b4.setBackgroundResource(R.drawable.org);b4.setOnClickListener { b4.text="$e" };b4.setTextColor(resources.getColor(R.color.black))
                          b5.text="$n" ;b5.setBackgroundResource(R.drawable.org);b5.setOnClickListener { b5.text="$n" };b5.setTextColor(resources.getColor(R.color.black))
                          b6.text="$l" ;b6.setBackgroundResource(R.drawable.org);b6.setOnClickListener { b6.text="$l" };b6.setTextColor(resources.getColor(R.color.black))
                          b7.text="$m" ;b7.setBackgroundResource(R.drawable.org);b7.setOnClickListener { b7.text="$m" };b7.setTextColor(resources.getColor(R.color.black))
                          b8.text="$i" ;b8.setBackgroundResource(R.drawable.org);b8.setOnClickListener { b8.text="$i" };b8.setTextColor(resources.getColor(R.color.black))
                          b9.text="$j" ;b9.setBackgroundResource(R.drawable.org);b9.setOnClickListener { b9.text="$j" };b9.setTextColor(resources.getColor(R.color.black))
                    //block 2
                    b11.text="$i";b11.setBackgroundResource(R.drawable.org2) ;b11.setOnClickListener { b11.text="$i" };b11.setTextColor(resources.getColor(R.color.black))
                    b12.text="$l";b12.setBackgroundResource(R.drawable.org2) ;b12.setOnClickListener { b12.text="$l" };b12.setTextColor(resources.getColor(R.color.black))
                    b13.text="$m";b13.setBackgroundResource(R.drawable.org2) ;b13.setOnClickListener { b13.text="$m" };b13.setTextColor(resources.getColor(R.color.black))
                    b14.text="$d";b14.setBackgroundResource(R.drawable.org2) ;b14.setOnClickListener { b14.text="$d" };b14.setTextColor(resources.getColor(R.color.black))
                    b15.text="$k";b15.setBackgroundResource(R.drawable.org2) ;b15.setOnClickListener { b15.text="$k" };b15.setTextColor(resources.getColor(R.color.black))
                    b16.text="$j";b16.setBackgroundResource(R.drawable.org2) ;b16.setOnClickListener { b16.text="$j" };b16.setTextColor(resources.getColor(R.color.black))
                    b17.text="$f";b17.setBackgroundResource(R.drawable.org2) ;b17.setOnClickListener { b17.text="$f" };b17.setTextColor(resources.getColor(R.color.black))
                    b18.text="$n";b18.setBackgroundResource(R.drawable.org2) ;b18.setOnClickListener { b18.text="$n" };b18.setTextColor(resources.getColor(R.color.black))
                    b19.text="$e";b19.setBackgroundResource(R.drawable.org2) ;b19.setOnClickListener { b19.text="$e" };b19.setTextColor(resources.getColor(R.color.black))
                    //block3
                     b31.text="$j";b31.setBackgroundResource(R.drawable.org) ;b31.setOnClickListener { b31.text="$j" };b31.setTextColor(resources.getColor(R.color.black))
                     b32.text="$e";b32.setBackgroundResource(R.drawable.org) ;b32.setOnClickListener { b32.text="$e" };b32.setTextColor(resources.getColor(R.color.black))
                     b33.text="$n";b33.setBackgroundResource(R.drawable.org) ;b33.setOnClickListener { b33.text="$n" };b33.setTextColor(resources.getColor(R.color.black))
                     b34.text="$i";b34.setBackgroundResource(R.drawable.org) ;b34.setOnClickListener { b34.text="$i" };b34.setTextColor(resources.getColor(R.color.black))
                     b35.text="$m";b35.setBackgroundResource(R.drawable.org) ;b35.setOnClickListener { b35.text="$m" };b35.setTextColor(resources.getColor(R.color.black))
                     b36.text="$f";b36.setBackgroundResource(R.drawable.org) ;b36.setOnClickListener { b36.text="$f" };b36.setTextColor(resources.getColor(R.color.black))
                     b37.text="$k";b37.setBackgroundResource(R.drawable.org) ;b37.setOnClickListener { b37.text="$k" };b37.setTextColor(resources.getColor(R.color.black))
                     b38.text="$d";b38.setBackgroundResource(R.drawable.org) ;b38.setOnClickListener { b38.text="$d" };b38.setTextColor(resources.getColor(R.color.black))
                     b39.text="$l";b39.setBackgroundResource(R.drawable.org) ;b39.setOnClickListener { b39.text="$l" };b39.setTextColor(resources.getColor(R.color.black))
                     //block 4
                    b41.text="$k";b41.setBackgroundResource(R.drawable.org2) ;b41.setOnClickListener { b41.text="$k" };b41.setTextColor(resources.getColor(R.color.black))
                    b42.text="$m";b42.setBackgroundResource(R.drawable.org2) ;b42.setOnClickListener { b42.text="$m" };b42.setTextColor(resources.getColor(R.color.black))
                    b43.text="$f";b43.setBackgroundResource(R.drawable.org2) ;b43.setOnClickListener { b43.text="$f" };b43.setTextColor(resources.getColor(R.color.black))
                    b44.text="$i";b44.setBackgroundResource(R.drawable.org2) ;b44.setOnClickListener { b44.text="$i" };b44.setTextColor(resources.getColor(R.color.black))
                    b45.text="$j";b45.setBackgroundResource(R.drawable.org2) ;b45.setOnClickListener { b45.text="$j" };b45.setTextColor(resources.getColor(R.color.black))
                    b46.text="$n";b46.setBackgroundResource(R.drawable.org2) ;b46.setOnClickListener { b46.text="$n" };b46.setTextColor(resources.getColor(R.color.black))
                    b47.text="$l";b47.setBackgroundResource(R.drawable.org2) ;b47.setOnClickListener { b47.text="$l" };b47.setTextColor(resources.getColor(R.color.black))
                    b48.text="$e";b48.setBackgroundResource(R.drawable.org2) ;b48.setOnClickListener { b48.text="$e" };b48.setTextColor(resources.getColor(R.color.black))
                    b49.text="$d";b49.setBackgroundResource(R.drawable.org2) ;b49.setOnClickListener { b49.text="$d" };b49.setTextColor(resources.getColor(R.color.black))
                    //B5
                      b52.text="$e";b2.setBackgroundResource(R.drawable.org) ;b52.setOnClickListener { b52.text="$e" };b51.setTextColor(resources.getColor(R.color.black))
                      b53.text="$n";b3.setBackgroundResource(R.drawable.org) ;b53.setOnClickListener { b53.text="$n" };b52.setTextColor(resources.getColor(R.color.black))
                      b54.text="$k";b4.setBackgroundResource(R.drawable.org) ;b54.setOnClickListener { b54.text="$k" };b53.setTextColor(resources.getColor(R.color.black))
                      b55.text="$d";b5.setBackgroundResource(R.drawable.org) ;b55.setOnClickListener { b55.text="$d" };b54.setTextColor(resources.getColor(R.color.black))
                      b56.text="$f";b6.setBackgroundResource(R.drawable.org) ;b56.setOnClickListener { b56.text="$f" };b55.setTextColor(resources.getColor(R.color.black))
                      b57.text="$m";b7.setBackgroundResource(R.drawable.org) ;b57.setOnClickListener { b57.text="$m" };b56.setTextColor(resources.getColor(R.color.black))
                      b58.text="$j";b8.setBackgroundResource(R.drawable.org) ;b58.setOnClickListener { b58.text="$j" };b57.setTextColor(resources.getColor(R.color.black))
                      b59.text="$i";b9.setBackgroundResource(R.drawable.org) ;b59.setOnClickListener { b59.text="$i" };b58.setTextColor(resources.getColor(R.color.black))
                      //b6
                    b61.text="$d";b61.setBackgroundResource(R.drawable.org2) ;b61.setOnClickListener { b61.text="$d" };b61.setTextColor(resources.getColor(R.color.black))
                    b62.text="$i";b62.setBackgroundResource(R.drawable.org2) ;b62.setOnClickListener { b62.text="$i" };b62.setTextColor(resources.getColor(R.color.black))
                    b63.text="$j";b63.setBackgroundResource(R.drawable.org2) ;b63.setOnClickListener { b63.text="$j" };b63.setTextColor(resources.getColor(R.color.black))
                    b64.text="$e";b64.setBackgroundResource(R.drawable.org2) ;b64.setOnClickListener { b64.text="$e" };b64.setTextColor(resources.getColor(R.color.black))
                    b65.text="$l";b65.setBackgroundResource(R.drawable.org2) ;b65.setOnClickListener { b65.text="$l" };b65.setTextColor(resources.getColor(R.color.black))
                    b66.text="$m";b66.setBackgroundResource(R.drawable.org2) ;b66.setOnClickListener { b66.text="$m" };b66.setTextColor(resources.getColor(R.color.black))
                    b67.text="$f";b67.setBackgroundResource(R.drawable.org2) ;b67.setOnClickListener { b67.text="$f" };b67.setTextColor(resources.getColor(R.color.black))
                    b68.text="$n";b68.setBackgroundResource(R.drawable.org2) ;b68.setOnClickListener { b68.text="$n" };b68.setTextColor(resources.getColor(R.color.black))
                    b69.text="$k";b69.setBackgroundResource(R.drawable.org2) ;b69.setOnClickListener { b69.text="$k" };b69.setTextColor(resources.getColor(R.color.black))
                    //b7
                     b71.text="$j";b71.setBackgroundResource(R.drawable.org) ;b71.setOnClickListener { b71.text="$j" };b71.setTextColor(resources.getColor(R.color.black))
                     b72.text="$d";b72.setBackgroundResource(R.drawable.org) ;b72.setOnClickListener { b72.text="$d" };b72.setTextColor(resources.getColor(R.color.black))
                     b73.text="$i";b73.setBackgroundResource(R.drawable.org) ;b73.setOnClickListener { b73.text="$i" };b73.setTextColor(resources.getColor(R.color.black))
                     b74.text="$f";b74.setBackgroundResource(R.drawable.org) ;b74.setOnClickListener { b74.text="$f" };b74.setTextColor(resources.getColor(R.color.black))
                     b75.text="$l";b75.setBackgroundResource(R.drawable.org) ;b75.setOnClickListener { b75.text="$l" };b75.setTextColor(resources.getColor(R.color.black))
                     b76.text="$m";b76.setBackgroundResource(R.drawable.org) ;b76.setOnClickListener { b76.text="$m" };b76.setTextColor(resources.getColor(R.color.black))
                     b77.text="$n";b77.setBackgroundResource(R.drawable.org) ;b77.setOnClickListener { b77.text="$n" };b77.setTextColor(resources.getColor(R.color.black))
                     b78.text="$k";b78.setBackgroundResource(R.drawable.org) ;b78.setOnClickListener { b78.text="$k" };b78.setTextColor(resources.getColor(R.color.black))
                     b79.text="$e";b79.setBackgroundResource(R.drawable.org) ;b79.setOnClickListener { b79.text="$e" };b79.setTextColor(resources.getColor(R.color.black))
                    //b8
                     b81.text="$n";b1.setBackgroundResource(R.drawable.org2) ;b81.setOnClickListener { b81.text="$n" };b81.setTextColor(resources.getColor(R.color.black))
                     b82.text="$f";b2.setBackgroundResource(R.drawable.org2) ;b82.setOnClickListener { b82.text="$f" };b82.setTextColor(resources.getColor(R.color.black))
                     b83.text="$l";b3.setBackgroundResource(R.drawable.org2) ;b83.setOnClickListener { b83.text="$l" };b83.setTextColor(resources.getColor(R.color.black))
                     b84.text="$e";b4.setBackgroundResource(R.drawable.org2) ;b84.setOnClickListener { b84.text="$e" };b84.setTextColor(resources.getColor(R.color.black))
                     b85.text="$i";b5.setBackgroundResource(R.drawable.org2) ;b85.setOnClickListener { b85.text="$i" };b85.setTextColor(resources.getColor(R.color.black))
                     b86.text="$k";b6.setBackgroundResource(R.drawable.org2) ;b86.setOnClickListener { b86.text="$k" };b86.setTextColor(resources.getColor(R.color.black))
                     b87.text="$j";b7.setBackgroundResource(R.drawable.org2) ;b87.setOnClickListener { b87.text="$j" };b87.setTextColor(resources.getColor(R.color.black))
                     b88.text="$m";b8.setBackgroundResource(R.drawable.org2) ;b88.setOnClickListener { b88.text="$m" };b88.setTextColor(resources.getColor(R.color.black))
                     b89.text="$d";b9.setBackgroundResource(R.drawable.org2) ;b89.setOnClickListener { b89.text="$d" };b89.setTextColor(resources.getColor(R.color.black))
                     //Block
                     b91.text="$m";b91.setBackgroundResource(R.drawable.org) ;b91.setOnClickListener { b91.text="$m" };b91.setTextColor(resources.getColor(R.color.black))
                     b92.text="$k";b92.setBackgroundResource(R.drawable.org) ;b92.setOnClickListener { b92.text="$k" };b92.setTextColor(resources.getColor(R.color.black))
                     b93.text="$e";b93.setBackgroundResource(R.drawable.org) ;b93.setOnClickListener { b93.text="$e" };b93.setTextColor(resources.getColor(R.color.black))
                     b94.text="$n";b94.setBackgroundResource(R.drawable.org) ;b94.setOnClickListener { b94.text="$n" };b94.setTextColor(resources.getColor(R.color.black))
                     b95.text="$j";b95.setBackgroundResource(R.drawable.org) ;b95.setOnClickListener { b95.text="$j" };b95.setTextColor(resources.getColor(R.color.black))
                     b96.text="$d";b96.setBackgroundResource(R.drawable.org) ;b96.setOnClickListener { b96.text="$d" };b96.setTextColor(resources.getColor(R.color.black))
                     b97.text="$l";b97.setBackgroundResource(R.drawable.org) ;b97.setOnClickListener { b97.text="$l" };b97.setTextColor(resources.getColor(R.color.black))
                     b98.text="$f";b98.setBackgroundResource(R.drawable.org) ;b98.setOnClickListener { b98.text="$f" };b98.setTextColor(resources.getColor(R.color.black))
                     b99.text="$i";b99.setBackgroundResource(R.drawable.org) ;b99.setOnClickListener { b99.text="$i" };b99.setTextColor(resources.getColor(R.color.black))
                    ...
                    while (a<=random){
                        when(Random.nextInt(1..81)){
                             ...
                             59->{b59.text="";keys(buSelected = b59);b59.setBackgroundResource(R.drawable.org)}
